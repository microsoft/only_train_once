...
setup(
    ...
    url="https://github.com/microsoft/only_train_once",
    keywords='automatic, architecture-agnostic, DNN training, compression, structured pruning, erasing operator, one-shot',
    classifiers= [
