...
Preliminary script for experimenting OTO pruning mode on Bert SQuAD

python 02.preliminary_bert_squad.py --model_name_or_path bert-base-uncased 
                                    --dataset_name squad 
...
def main():
    ...
    # Set up hyper-parameters exactly the same as baseline optimizers.
    optimizer = oto.hesso(
        variant='adamw', 
